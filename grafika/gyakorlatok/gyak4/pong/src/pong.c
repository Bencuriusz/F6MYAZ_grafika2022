...
{
    float left = pong->ball.x - pong->ball.radius;
    float right = pong->ball.x + pong->ball.radius;
    float top = pong->ball.y - pong->ball.radius;
    float bottom = pong->ball.y + pong->ball.radius;
